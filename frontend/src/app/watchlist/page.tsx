  ...
  return (
    <DashboardLayout>
      <div className="space-y-6 pb-16">
        ...
        {/* ========================================================= */}
        <div className="rounded-2xl border border-slate-800 bg-[#081225]/90 p-6 backdrop-blur-xl shadow-2xl">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            {/* Title & Description */}
            <div>
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-amber-500/30 bg-amber-500/10 text-amber-400 shadow-lg shadow-amber-500/10">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <button
                ...
                className="flex items-center gap-2 rounded-xl border border-cyan-500/40 bg-cyan-500/10 px-4 py-2.5 text-xs font-bold text-cyan-300 transition-all hover:border-cyan-400 hover:bg-cyan-500/20 hover:shadow-lg hover:shadow-cyan-500/10"
              >
                <Plus size={16} />
              ...
              {activeWl && (
                <>
                  <button
                    ...
                    className="flex items-center gap-1.5 rounded-xl border border-slate-700 bg-slate-800/80 px-3 py-2.5 text-xs font-medium text-slate-300 transition-all hover:bg-slate-700 hover:text-white"
                  >
                    <Edit3 size={14} />
                    <span>Rename</span>
                  </button>
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 rounded-xl border border-rose-500/30 bg-rose-500/10 px-3 py-2.5 text-xs font-medium text-rose-400 transition-all hover:bg-rose-500/20 hover:text-rose-300"
                  >
                    <Trash2 size={14} />
                    <span>Delete</span>
                  </button>
                ...
                return (
                  <button
                    ...
                    className={`group flex items-center gap-2.5 rounded-xl px-4 py-2.5 text-xs font-bold transition-all ${
                      isActive
                        ? "border border-cyan-500/60 bg-gradient-to-r from-cyan-500/20 to-blue-500/10 text-cyan-300 shadow-md shadow-cyan-500/10"
                        : "border border-slate-800 bg-slate-900/60 text-slate-400 hover:border-slate-700 hover:bg-slate-800/60 hover:text-slate-200"
                    }`}
                  >
                    <span
        ...
        {activeSummary && (
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
            {/* Total Equities */}
            <div className="rounded-xl border border-slate-800 bg-[#0B1528]/80 p-4 backdrop-blur-md">
            ...
            <div className="rounded-xl border border-amber-500/20 bg-amber-500/5 p-4 backdrop-blur-md">
              ...
              <div className="mt-2 flex items-baseline gap-1.5">
                ...
                <span className="text-xs text-amber-500/80 font-bold">/ 5.0</span>
              </div>
            </div>

            {/* High Conviction (4-5 Stars) */}
            <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-4 backdrop-blur-md">
              <div className="flex items-center justify-between">
              ...
              <div className="mt-2 flex items-baseline gap-2">
                ...
                <span className="text-xs text-emerald-500/80">picks</span>
              </div>
            </div>

            {/* Average ROCE */}
            <div className="rounded-xl border border-cyan-500/20 bg-cyan-500/5 p-4 backdrop-blur-md">
              <div className="flex items-center justify-between">
              ...
              <div className="mt-2 flex items-baseline gap-2">
                ...
                <span className="text-xs text-cyan-500/80 font-semibold">return</span>
              </div>
            </div>
          </div>
        )}
        ...
        {/* ========================================================= */}
        <div className="rounded-2xl border border-slate-800 bg-[#0B1528]/80 p-5 backdrop-blur-md">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            {/* AUTCOMPLETE SEARCH INPUT */}
            <div ref={searchContainerRef} className="relative w-full max-w-xl">
              <div className="flex items-center gap-3 rounded-xl border border-slate-700 bg-slate-900/90 px-4 py-3 focus-within:border-cyan-500/70 focus-within:ring-2 focus-within:ring-cyan-500/20">
              ...
              {showSearchDropdown && searchResults.length > 0 && (
                <div className="absolute left-0 right-0 top-full z-50 mt-2 max-h-96 overflow-y-auto rounded-xl border border-slate-700 bg-[#081225] p-2 shadow-2xl backdrop-blur-2xl">
                  ...
                  {searchResults.map((stock) => {
                    ...
                    return (
                      <div
                        key={stock.symbol}
                        className="flex items-center justify-between rounded-lg p-2.5 transition-all hover:bg-slate-800/80"
                      >
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center gap-2">
                            ...
                            {stock.sector && (
                              <span className="hidden sm:inline-block rounded bg-cyan-950/60 px-1.5 py-0.5 text-[10px] font-medium text-cyan-400">
                                {stock.sector}
                              </span>
                            )}
                          </div>
                        ...
                        <div className="flex items-center gap-4 text-right">
                          ...
                          <button
                            ...
                            className={`flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs font-bold transition-all ${
                              isAlreadyAdded
                                ? "border border-slate-700 bg-slate-800/40 text-slate-500 cursor-not-allowed"
                                : "border border-cyan-500/50 bg-cyan-500/20 text-cyan-300 hover:bg-cyan-500/30 hover:border-cyan-400"
                            }`}
                          >
                            {isAlreadyAdded ? (
                              <>
            ...
            <div className="flex flex-wrap items-center gap-3">
              {/* Table search filter */}
              <div className="flex items-center gap-2 rounded-xl border border-slate-800 bg-slate-900/60 px-3 py-2 text-xs">
                ...
                <input
                  ...
                  className="w-28 bg-transparent text-white placeholder:text-slate-500 outline-none sm:w-36"
                />
              </div>
              ...
              <div className="flex items-center gap-2">
                <select
                  ...
                  className="rounded-xl border border-slate-800 bg-slate-900 px-3 py-2 text-xs font-semibold text-slate-300 outline-none"
                >
        ...
        {/* ========================================================= */}
        <div className="overflow-hidden rounded-2xl border border-slate-800 bg-[#081225]/80 shadow-2xl backdrop-blur-md">
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-slate-800 bg-slate-900/80 font-mono uppercase text-slate-400">
                <tr>
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-4 py-3.5">
                          ...
                          <div className="truncate text-slate-400 text-[11px] max-w-[200px]">
                            {item.company_name}
                          </div>
                        ...
                        <td className="px-4 py-3.5">
                          <div className="relative">
                            <textarea
                              ...
                              className="w-full resize-none rounded-xl border border-slate-800 bg-slate-900/70 p-2 text-xs text-slate-200 placeholder:text-slate-600 outline-none transition-all focus:border-cyan-500/60 focus:bg-slate-900 focus:ring-1 focus:ring-cyan-500/20"
                            />

                            {/* Saved Feedback Badge */}
                            {isSaved && (
                              <div className="absolute right-2 top-2 flex items-center gap-1 rounded bg-emerald-500/20 px-1.5 py-0.5 text-[10px] font-bold text-emerald-400 border border-emerald-500/40 shadow-sm animate-pulse">
                                <Check size={11} />
                                <span>Saved</span>
                              </div>
                            )}
                        ...
                        <td className="px-4 py-3.5 text-center">
                          <button
                            ...
                            className="flex h-8 w-8 items-center justify-center rounded-lg text-slate-500 transition-all hover:bg-rose-500/20 hover:text-rose-400"
                          >
                            <Trash2 size={15} />
                          </button>
                        </td>
        ...
        {showCreateModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4 backdrop-blur-sm">
            <div className="w-full max-w-md rounded-2xl border border-slate-800 bg-[#081225] p-6 shadow-2xl">
              ...
              <form onSubmit={handleCreateWatchlist} className="mt-5 space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="mt-1 w-full rounded-xl border border-slate-700 bg-slate-900 px-3 py-2.5 text-sm text-white placeholder:text-slate-500 outline-none focus:border-cyan-500"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="mt-1 w-full resize-none rounded-xl border border-slate-700 bg-slate-900 px-3 py-2 text-sm text-white placeholder:text-slate-500 outline-none focus:border-cyan-500"
                  />
                </div>
                ...
                <div className="mt-6 flex justify-end gap-3 border-t border-slate-800 pt-4">
                  ...
                  <button
                    ...
                    className="rounded-xl border border-cyan-500 bg-cyan-500/20 px-5 py-2 text-xs font-bold text-cyan-300 hover:bg-cyan-500/30"
                  >
                    Create Watchlist
                  </button>
                </div>
              ...
              <form onSubmit={handleUpdateWatchlist} className="mt-5 space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="mt-1 w-full rounded-xl border border-slate-700 bg-slate-900 px-3 py-2.5 text-sm text-white outline-none focus:border-cyan-500"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="mt-1 w-full resize-none rounded-xl border border-slate-700 bg-slate-900 px-3 py-2 text-sm text-white outline-none focus:border-cyan-500"
                  />
                </div>
