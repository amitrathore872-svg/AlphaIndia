    ...
    <DashboardLayout>
      <div className="space-y-6 p-6">
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between border-b border-slate-800/80 pb-5">
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            ...
            <Link
              ...
              className="flex items-center gap-1.5 rounded-xl border border-cyan-300 dark:border-cyan-800/60 bg-cyan-50 dark:bg-cyan-950/40 px-3.5 py-2 text-xs font-semibold text-cyan-700 dark:text-cyan-300 transition hover:bg-cyan-100 dark:hover:bg-cyan-900/60 shadow-xs"
            >
            ...
            <button
              onClick={() => loadData()}
              className="flex items-center gap-1.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-3 py-2 text-xs font-medium text-slate-700 dark:text-slate-300 transition hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white shadow-xs"
            >
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/80 p-4 shadow-xs">
            <div className="flex items-center justify-between text-xs text-slate-500 dark:text-slate-400">
              <span>Screener Equities</span>
              <PieChart className="h-4 w-4 text-cyan-500 dark:text-cyan-400" />
            </div>
        ...
        {/* Filter Toolbar */}
        <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 p-4 space-y-4 shadow-xs">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/90 py-2 pl-10 pr-4 text-sm text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:border-cyan-500 focus:outline-none focus:ring-1 focus:ring-cyan-500"
              />
            </div>

            {/* Sector Dropdown */}
            <div className="flex items-center gap-2">
              <span className="text-xs text-slate-600 dark:text-slate-400">Sector:</span>
              <select
                value={sector}
                onChange={(e) => {
            ...
            <div className="flex items-center gap-1 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-100 dark:bg-slate-900/80 p-1">
        ...
        <div className="overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 shadow-xs dark:shadow-xl">
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs whitespace-nowrap">
              <thead className="border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-[#0B1528] text-slate-600 dark:text-slate-400 font-semibold select-none">
                <tr>
                ...
                {loading ? (
                  ...
                  <tr>
                    <td colSpan={viewMode === "EXPANDED" ? 27 : 20} className="px-6 py-12 text-center text-slate-400">
                      <p className="text-base font-semibold text-slate-700 dark:text-slate-300">No records found</p>
          ...
          {/* Pagination Controls */}
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between border-t border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/60 px-4 py-3 text-xs text-slate-600 dark:text-slate-400">
            <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-1.5">
              <button
                ...
                className="flex items-center gap-1 rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-2.5 py-1 text-xs font-medium text-slate-700 dark:text-slate-300 transition hover:bg-slate-100 dark:hover:bg-slate-800 disabled:opacity-40"
              >
        ...
        {showWatchlistModal && selectedStock && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 p-4 backdrop-blur-sm">
            <div className="w-full max-w-lg rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#081225] p-6 shadow-2xl">
              {/* Modal Header */}
              <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-4">
                <div className="flex items-center gap-2.5">
                  <div className="flex h-9 w-9 items-center justify-center rounded-xl border border-amber-500/30 bg-amber-500/10 text-amber-500 dark:text-amber-400">
                    <Star size={18} className="fill-amber-400 text-amber-500 dark:text-amber-400" />
                  </div>
                  <div>
                    <h3 className="text-base font-bold text-slate-900 dark:text-white flex items-center gap-2">
                      <span>Add to Watchlist</span>
                      <span className="rounded bg-cyan-50 dark:bg-cyan-950/70 text-cyan-700 dark:text-cyan-300 border border-cyan-200 dark:border-cyan-700/50 px-2 py-0.5 text-xs font-mono">
              ...
              <div className="mt-4 grid grid-cols-3 gap-2 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/60 p-3 text-xs">
                <div>
              ...
              <form onSubmit={handleConfirmAddToWatchlist} className="mt-5 space-y-4">
                ...
                <div>
                  ...
                  <div className="mt-2 flex items-center gap-2 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/60 p-3">
                        ...
                        >
                          <Star
                            ...
                            className={`transition-colors ${
                              isFilled
                                ? selectedConfidence === 5
                                  ? "fill-emerald-400 text-emerald-500 dark:text-emerald-400"
                                  : selectedConfidence === 4
                                  ? "fill-cyan-400 text-cyan-500 dark:text-cyan-400"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="mt-1.5 w-full resize-none rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 p-3 text-xs text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-600 outline-none focus:border-cyan-500"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="mt-1.5 w-full rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 px-3 py-2 text-xs text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-600 outline-none focus:border-cyan-500"
                  />
                </div>
                ...
                <div className="mt-6 flex justify-end gap-3 border-t border-slate-200 dark:border-slate-800 pt-4">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 rounded-xl border border-amber-500/50 bg-amber-500/20 px-5 py-2 text-xs font-bold text-amber-600 dark:text-amber-300 hover:bg-amber-500/30 hover:border-amber-400 transition-all shadow-md shadow-amber-500/10"
                  >
                    {watchlistSubmitting ? (
        ...
        {/* ========================================================= */}
        {successToast && (
          <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3 rounded-2xl border border-emerald-500/40 bg-white/95 dark:bg-[#081225]/95 px-4 py-3 shadow-2xl backdrop-blur-xl">
            ...
            <span className="text-xs font-bold text-slate-900 dark:text-slate-200">{successToast}</span>
            <Link
              href="/watchlist"
              className="ml-2 rounded-lg border border-cyan-500/40 bg-cyan-500/10 px-2.5 py-1 text-[11px] font-bold text-cyan-600 dark:text-cyan-300 hover:bg-cyan-500/20"
            >
              Open Watchlist →
            </Link>
          </div>
